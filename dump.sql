...
('Marie', 'Dupont', 'marie.dupont@email.com', 'CV de Marie Dupont avec expérience en marketing', '1998-05-15', false),
('Thomas', 'Martin', 'thomas.martin@email.com', 'CV de Thomas Martin, spécialiste en développement web', '1995-11-23', true),
('Sophie', 'Bernard', 'sophie.bernard@email.com', 'CV de Sophie Bernard, passionnée de design', '1999-03-10', false),
('Lucas', 'Petit', 'lucas.petit@email.com', 'CV de Lucas Petit avec compétences en réseaux', '1997-07-08', false),
